...
%                 % load file
%                 dataname=strcat('MGPE-FD1d-Bet-',int2str(data.beta),'-Del-',int2str(data.delta),'-Vep-',num2str(vep),'-NN-',int2str(NN_start),'_n.mat');
%                 load(dataname,'Rho');
%                 X0=Rho(2:end-1);
            elseif (dN==1 && dvep>1)
%                 dataname=strcat('MGPE-FD1d-Bet-',int2str(data.beta),'-Del-',int2str(data.delta),'-Vep-',num2str(vep*2),'-NN-',int2str(NN_end),'_n.mat');
%                 load(dataname,'Rho'); %%
